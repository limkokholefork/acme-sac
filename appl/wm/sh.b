...
shwin_cfg := array[] of {
	...
	"frame .b -bd 1 -relief flat",
	"frame .ft -bd 0",
	"scrollbar .ft.scroll  -relief flat -width 14  -command {send scroll t}",
	"text .ft.t -bd 1 -relief flat -yscrollcommand {send scroll s} -bg #dddddd -selectforeground black -selectbackground #CCCCCC",
			...
			args: list of string)
{
	...
	fd0 = fd1 = fd2 = nil; # quiet the compiler
}
